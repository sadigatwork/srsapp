...
const translations = {
  en: {
    ...
    welcomeDesc: "Register, manage your professional profile, and apply for certification",
    ...
    approved: "Approved",
    rejected: "Rejected",
    footer: "© 2023 Professional Registration Management System. All rights reserved.",
    switchLanguage: "العربية",
    // About page translations
    aboutTitle: "About the Engineering Classification System",
    aboutDescription: "Learn about our mission, vision, and the services we provide to the engineering community.",
    mission: "Our Mission",
    missionContent:
    ...
    values: "Our Values",
    integrity: "Integrity",
    integrityDesc: "We uphold the highest ethical standards in all our operations and decisions.",
    ...
    collaborationDesc: "We work collaboratively with engineers, institutions, and stakeholders to achieve our mission.",
    ...
    faqQuestion5: "What is the difference between classification and certification?",
    faqAnswer5:
    ...
    uploadCertificateDescription: "Upload your degree certificate (PDF, JPG, PNG)",
    update: "Update",
    yourEducation: "Your Education",
    noEducationAdded: "No education records added yet",
    confirmDelete: "Confirm Delete",
    deleteEducationConfirmation: "Are you sure you want to delete this education record?",
    ...
    deletePublicationConfirmation: "Are you sure you want to delete this publication?",
    ...
    uploadExperienceCertificateDescription: "Upload your experience certificate (PDF, JPG, PNG)",
    yourExperience: "Your Experience",
    noExperienceAdded: "No experience records added yet",
    deleteExperienceConfirmation: "Are you sure you want to delete this experience record?",
    ...
    uploadCertificationDescription: "Upload your certification document (PDF, JPG, PNG)",
    yourCertifications: "Your Certifications",
    noCertificationsAdded: "No certifications added yet",
    deleteCertificationConfirmation: "Are you sure you want to delete this certification?",
    in: "in",
    present: "Present",
  ...
  ar: {
    ...
    aboutDescription: "تعرف على رسالتنا ورؤيتنا والخدمات التي نقدمها لمجتمع الهندسة.",
    mission: "رسالتنا",
    missionContent:
    ...
    values: "قيمنا",
    integrity: "النزاهة",
    integrityDesc: "نحن نلتزم بأعلى المعايير الأخلاقية في جميع عملياتنا وقراراتنا.",
    excellence: "التميز",
    excellenceDesc: "نحن نسعى للتميز في خدماتنا وفي المعايير التي نضعها لمهنة الهندسة.",
    innovation: "الابتكار",
    innovationDesc: "نحن نتبنى الابتكار ونشجع تطوير أفكار ونهج جديدة في الممارسة الهندسية.",
    collaboration: "التعاون",
    collaborationDesc: "نحن نعمل بشكل تعاوني مع المهندسين والمؤسسات وأصحاب المصلحة لتحقيق مهمتنا.",
    accountability: "المساءلة",
    accountabilityDesc: "نحن مسؤولون عن أفعالنا وقراراتنا، ونتوقع نفس الشيء من المهندسين الذين نصنفهم.",
    services: "خدماتنا",
    ...
    institutionDirectoryDesc: "نحن نحتفظ بدليل شامل للمؤسسات الهندسية، مما يوفر موردًا قيمًا للتواصل والتعاون.",
    ...
    publicationsDesc: "نحن ننشر التقارير والإرشادات وأفضل الممارسات لدعم المجتمع الهندسي وتقدم المهنة.",
    faq: "الأسئلة الشائعة",
    ...
    certificate: "الشهادة",
    uploadCertificateDescription: "قم بتحميل شهادة الدرجة العلمية (PDF, JPG, PNG)",
    update: "تحديث",
    yourEducation: "مؤهلاتك التعليمية",
    noEducationAdded: "لم تتم إضافة أي مؤهلات تعليمية بعد",
    confirmDelete: "تأكيد الحذف",
    deleteEducationConfirmation: "هل أنت متأكد من رغبتك في حذف هذا المؤهل التعليمي؟",
    ...
    deletePublicationConfirmation: "هل أنت متأكد من رغبتك في حذف هذا المنشور العلمي؟",
    ...
    uploadExperienceCertificateDescription: "قم بتحميل شهادة الخبرة (PDF, JPG, PNG)",
    yourExperience: "خبراتك العملية",
    noExperienceAdded: "لم تتم إضافة أي خبرات عملية بعد",
    deleteExperienceConfirmation: "هل أنت متأكد من رغبتك في حذف هذه الخبرة العملية؟",
    ...
    deleteCertificationConfirmation: "هل أنت متأكد من رغبتك في حذف هذه الشهادة المهنية؟",
    in: "في",
    present: "حتى الآن",
